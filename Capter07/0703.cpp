/*
	演習7-3:符号無し整数xのposビット目を、1にした値を返す関数set、0にした値を返す関数reset、反転した値を返す関数inverse
	unsigned set(unsigned x, int pos)		unsigned reset(unsigned x, int pos)		unsigned inverse(unsigned x, int pos)を作成せよ。
*/
